...
setTimeout("location.href='http://10.10.10.98/adidas/c_21-30'", 10000);
</script>
<!-- Main content -->
         ...
         <table class="table" style="background-color: #e9e9e9;">
            ...
            <tr>
               ...
               <td>
                  ...
                  $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='C-$i' AND cal_f_c >= $pengurangan AND DATEPART(HOUR, dates)=7 AND CONVERT(date, dates) = CONVERT(date, CURRENT_TIMESTAMP)";
      ...
      //$d=sqlsrv_query($con,"SELECT dates,pass,detect,error FROM data_real_time WHERE no_cell=$i ORDER BY dates DESC LIMIT 1");
            ...
            <tr>
               ...
               <td>
                  ...
                  //$b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); 
                  //$sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='$i' AND cal_f_c >= 3 AND DATEPART(HOUR, dates)=7 AND dates = CURRENT_TIMESTAMP";
                  $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='C-$i' AND cal_f_c >= $pengurangan AND DATEPART(HOUR, dates)=9 AND CONVERT(date, dates) = CONVERT(date, CURRENT_TIMESTAMP)";
                  $a=sqlsrv_query($con,$sql);
                  $b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); ?>
                  <?php if ($a) {
					  $rows = sqlsrv_has_rows( $a );
            ...
            <tr>
               ...
               <td>
                 ...
                 // $b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH);
                //   $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='$i' AND cal_f_c >= 3 AND DATEPART(HOUR, dates)=7 AND dates = CURRENT_TIMESTAMP";
                $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='C-$i' AND cal_f_c >= $pengurangan AND DATEPART(HOUR, dates)=11 AND CONVERT(date, dates) = CONVERT(date, CURRENT_TIMESTAMP)";
                  $a=sqlsrv_query($con,$sql);
                  $b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); ?>
                  <?php if ($a) {
					  $rows = sqlsrv_has_rows( $a );
      ...
      //$d=sqlsrv_query($con,"SELECT dates,pass,detect,error FROM data_real_time WHERE no_cell=$i ORDER BY dates DESC LIMIT 1");
            ...
            <tr>
               ...
               <td>
                  ...
                  //$b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); 
                //$sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='$i' AND cal_f_c >= 3 AND DATEPART(HOUR, dates)=7 AND dates = CURRENT_TIMESTAMP";
                $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='C-$i' AND cal_f_c >= $pengurangan AND DATEPART(HOUR, dates)=13 AND CONVERT(date, dates) = CONVERT(date, CURRENT_TIMESTAMP)"; 
                  $a=sqlsrv_query($con,$sql);
                  $b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); ?>
                  <?php if ($a) {
					  $rows = sqlsrv_has_rows( $a );
            ...
            <tr>
               ...
               <td>
                 ...
                 //$sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='$i' AND cal_f_c >= 3 AND DATEPART(HOUR, dates)=7 AND dates = CURRENT_TIMESTAMP";
                 $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='C-$i' AND cal_f_c >= $pengurangan AND DATEPART(HOUR, dates)=15 AND CONVERT(date, dates) = CONVERT(date, CURRENT_TIMESTAMP)"; 
                  $a=sqlsrv_query($con,$sql);
                  $b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); ?>
                  <?php if ($a) {
					  $rows = sqlsrv_has_rows( $a );
