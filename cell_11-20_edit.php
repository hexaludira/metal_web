...
setTimeout("location.href='http://10.10.10.137/adidas/cell_21-30'", 10000);
</script>
<!-- Main content -->
         ...
         <table class="table" style="background-color: #e9e9e9;">
            ...
            <tr>
               ...
               <td>
                  <?php
                  //CALIBRASI JAM 7
                  $a=mysqli_query($con,"SELECT no_cell, cal_f_c, dates FROM data_real_time WHERE no_cell=$i AND cal_f_c > 0 AND DATE_FORMAT(dates,'%H')=7 AND date(dates)=CURRENT_DATE() LIMIT 1");
            ...
            <tr>
               ...
               <td>
                  <?php
                  //CALIBRASI JAM 9
                  $a=mysqli_query($con,"SELECT no_cell, cal_f_c, dates FROM data_real_time WHERE no_cell=$i AND cal_f_c > 0 AND DATE_FORMAT(dates,'%H')=9 AND date(dates)=CURRENT_DATE() LIMIT 1");
                  $b=mysqli_fetch_array($a); ?>
            ...
            <tr>
               ...
               <td>
                  <?php
                  //CALIBRASI JAM 11
                  $a=mysqli_query($con,"SELECT no_cell, cal_f_c, dates FROM data_real_time WHERE no_cell=$i AND cal_f_c > 0 AND DATE_FORMAT(dates,'%H')=11 AND date(dates)=CURRENT_DATE() LIMIT 1");
                  $b=mysqli_fetch_array($a); ?>
            ...
            <tr>
               ...
               <td>
                  <?php
                  //CALIBRASI JAM 13
                  $a=mysqli_query($con,"SELECT no_cell, cal_f_c, dates FROM data_real_time WHERE no_cell=$i AND cal_f_c > 0 AND DATE_FORMAT(dates,'%H')=13 AND date(dates)=CURRENT_DATE() LIMIT 1");
                  $b=mysqli_fetch_array($a); ?>
            ...
            <tr>
               ...
               <td>
                  <?php
                  //CALIBRASI JAM 15
                  $a=mysqli_query($con,"SELECT no_cell, cal_f_c, dates FROM data_real_time WHERE no_cell=$i AND cal_f_c > 0 AND DATE_FORMAT(dates,'%H')=15 AND date(dates)=CURRENT_DATE() LIMIT 1");
                  $b=mysqli_fetch_array($a); ?>
                  <?php if ($b) { ?>
                  <i class="btns btn-dangers btn-circle"></i>
                  <?php } else {?>
