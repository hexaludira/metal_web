...
<div class="content-header">
 <p class="text-center" style="font-size: 20px">
   ...
   <p class="text-center" style="font-size: 20px">
      <b>CELL 1 - 8</b> (<?php echo date('Y-m-d');?>)
   </p>
</div>
   ...
   <div class="row">
      ...
      for($i = $cell_awal; $i<= $cell_akhir; $i++){
		 ...
		 // $sql = "SELECT dates, no_cell, pass, detect, error,total FROM dbo.[data_real_time] WHERE pass=(SELECT max(pass) FROM dbo.[data_real_time] WHERE no_cell='$i') ORDER BY dates DESC LIMIT 1";
		  $pengurangan =3;
		 $sql = "select top 1 no_cell, dates, pass, detect, error from data_real_time where no_cell='B-0$i' order by dates desc";
         ...
         <table class="table" style="background-color: #e9e9e9;">
            ...
            <tr>
               ...
               <td>
                  ...
                  $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='B-0$i' AND cal_f_c >= $pengurangan AND DATEPART(HOUR, dates)=7 AND CONVERT(date, dates) = CONVERT(date, CURRENT_TIMESTAMP)";
      ...
      //$d=sqlsrv_query($con,"SELECT dates,pass,detect,error FROM data_real_time WHERE no_cell=$i ORDER BY dates DESC LIMIT 1");
            ...
            <tr>
               ...
               <td>
                  ...
                  //$b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); 
                  //$sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='$i' AND cal_f_c >= 3 AND DATEPART(HOUR, dates)=7 AND dates = CURRENT_TIMESTAMP";
                  $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='B-0$i' AND cal_f_c >= $pengurangan AND DATEPART(HOUR, dates)=9 AND CONVERT(date, dates) = CONVERT(date, CURRENT_TIMESTAMP)";
                  $a=sqlsrv_query($con,$sql);
                  $b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); ?>
                  <?php if ($a) {
					  $rows = sqlsrv_has_rows( $a );
            ...
            <tr>
               ...
               <td>
                 ...
                 // $b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH);
                //   $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='$i' AND cal_f_c >= 3 AND DATEPART(HOUR, dates)=7 AND dates = CURRENT_TIMESTAMP";
                $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='B-0$i' AND cal_f_c >= $pengurangan AND DATEPART(HOUR, dates)=11 AND CONVERT(date, dates) = CONVERT(date, CURRENT_TIMESTAMP)";
                  $a=sqlsrv_query($con,$sql);
                  $b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); ?>
                  <?php if ($a) {
					  $rows = sqlsrv_has_rows( $a );
      ...
      //$d=sqlsrv_query($con,"SELECT dates,pass,detect,error FROM data_real_time WHERE no_cell=$i ORDER BY dates DESC LIMIT 1");
            ...
            <tr>
               ...
               <td>
                  ...
                  //$b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); 
                //$sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='$i' AND cal_f_c >= 3 AND DATEPART(HOUR, dates)=7 AND dates = CURRENT_TIMESTAMP";
                $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='B-0$i' AND cal_f_c >= $pengurangan AND DATEPART(HOUR, dates)=13 AND CONVERT(date, dates) = CONVERT(date, CURRENT_TIMESTAMP)"; 
                  $a=sqlsrv_query($con,$sql);
                  $b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); ?>
                  <?php if ($a) {
					  $rows = sqlsrv_has_rows( $a );
            ...
            <tr>
               ...
               <td>
                 ...
                 //$sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='$i' AND cal_f_c >= 3 AND DATEPART(HOUR, dates)=7 AND dates = CURRENT_TIMESTAMP";
                 $sql="SELECT TOP 1 no_cell, cal_f_c, dates FROM dbo.[data_real_time] WHERE no_cell='B-0$i' AND cal_f_c >= $pengurangan AND DATEPART(HOUR, dates)=15 AND CONVERT(date, dates) = CONVERT(date, CURRENT_TIMESTAMP)"; 
                  $a=sqlsrv_query($con,$sql);
                  $b=sqlsrv_fetch_array($a,SQLSRV_FETCH_BOTH); ?>
                  <?php if ($a) {
					  $rows = sqlsrv_has_rows( $a );
