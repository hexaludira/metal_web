    ...
    <?php }?>
     ...
     <?php
      ...
      <div class="col-md-4 col-md-offset-4">
         <div class="box box-solid" style="background-color: #e9e9e9">
            <div class="box-header with-border">
               <h3 class="text-center" STYLE="font-size: 48px"><b>FACTORY E</b></h3>
            </div>
            <div class="box-body">
               <table class="table text-center">
                  <tr>
                     ...
                     <td bgcolor="#da5550" class="head" style="min-width:200px;font-size: 48px"><b>DETECT</b><p class="numb text-center"><b style="font-size: 48px"><?php echo $jml_array['jml_detect']; ?></b></p></td>
                     <td></td>
                     <td bgcolor="#f2aa56" class="head" style="min-width:200px;font-size: 48px"><b>ERROR</b><p class="numb text-center"><b style="font-size: 48px"><?php echo $erro_e['jml_error_e']; ?></b></p></td>
                  </tr>
               </table>
            </div>
         </div>
