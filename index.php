   ...
   <div class="row">
	  ...
	  if ($wkt_reset == 07){
		  ...
		  $resets = sqlsrv_query($con, $sqls);
               ...
               $sql_insert = "MERGE INTO GEDUNG_E
                              USING
                              (select NO_CELL, MAX(PASS) AS PASS, MAX(DETECT) AS DETECT, MAX(ERROR) AS ERROR from data_real_time WHERE CONVERT(DATE,DATES)=CONVERT(DATE,CURRENT_TIMESTAMP) AND NO_CELL LIKE 'E-%'
                                                   GROUP BY NO_CELL
                                                   ) AS A
                              ON GEDUNG_E.NO_CELL = A.NO_CELL
                              WHEN MATCHED THEN
                              UPDATE SET PASS = A.PASS, DETECT=A.DETECT, ERROR=A.ERROR
                              WHEN NOT MATCHED THEN
                              INSERT (NO_CELL, PASS, DETECT, ERROR) VALUES (A.NO_CELL, A.PASS, A.DETECT, A.ERROR);";
               $sql_insert = sqlsrv_query($con,$sql_insert);
      ...
      $sql_jumlah_b = "SELECT SUM(pass) AS jml_pass_b, SUM(detect) AS jml_detect_b FROM dbo.[gedung_b] ";
       $sql_error_b = "SELECT count(error) AS jml_error_b FROM dbo.[gedung_b] where error>=20 ";
     ...
     $sql_error_d = "SELECT count(error) AS jml_error_d FROM dbo.[gedung_d] where error>=20 ";
      $sql_jumlah_e = "SELECT SUM(pass) AS jml_pass_e, SUM(detect) AS jml_detect_e FROM dbo.[gedung_e]";
     $sql_error_e = "SELECT count(error) AS jml_error_e FROM dbo.[gedung_e] where error>=20 ";


      $q_a = sqlsrv_query($con, $sql_jumlah_a);
      $r_a = sqlsrv_query($con, $sql_error_a);
     $q_b = sqlsrv_query($con, $sql_jumlah_b);
     $r_b = sqlsrv_query($con, $sql_error_b);
     ...
     $r_d = sqlsrv_query($con, $sql_error_d);
      $q_e = sqlsrv_query($con, $sql_jumlah_e);
     $r_e = sqlsrv_query($con, $sql_error_e);
      ...
      $er_b = sqlsrv_fetch_array($r_b, SQLSRV_FETCH_BOTH);
     ...
     $er_d = sqlsrv_fetch_array($r_d, SQLSRV_FETCH_BOTH);
      $array_e = sqlsrv_fetch_array($q_e, SQLSRV_FETCH_BOTH);
	  $er_e = sqlsrv_fetch_array($r_e, SQLSRV_FETCH_BOTH);

      // $jml_pass_all = $array_a['jml_pass_a'] +  $array_c['jml_pass_c'] + $array_d['jml_pass_d'] + $array_e['jml_pass_e'];
      // $jml_detect_all = $array_a['jml_detect_a'] +  $array_c['jml_detect_c'] + $array_d['jml_detect_d'] + $array_e['jml_detect_e'];
      // $jml_error_all = $er_a['jml_error_a'] + $er_c['jml_error_c'] + $er_d['jml_error_d'] + $er_e['jml_error_e'];

      //All Building (A, B, C, D, E)
      $jml_pass_all = $array_a['jml_pass_a'] + $array_b['jml_pass_b'] + $array_c['jml_pass_c'] + $array_d['jml_pass_d'] + $array_e['jml_pass_e'];
      $jml_detect_all = $array_a['jml_detect_a'] + $array_b['jml_detect_b'] +  $array_c['jml_detect_c'] + $array_d['jml_detect_d'] + $array_e['jml_detect_e'];
      $jml_error_all = $er_a['jml_error_a'] + $er_b['jml_error_b'] + $er_c['jml_error_c'] + $er_d['jml_error_d'] + $er_e['jml_error_e'];
	  ?>
    
      <div class="col-xs-4 col-lg-4">
         <div class="pass-o pull-right text-center"><br>
			<p style="padding-top: 50px;font-size: 120px;"><b>PASS</b></p>
            <p style="padding-top:5px;font-size: 220px"><b><?php echo $jml_pass_all; ?></b></p>
      ...
      <div class="col-xs-4 col-lg-4">
         <div class="detect-o text-center"><br>
			<p style="padding-top: 50px;font-size: 120px"><b>DETECT</b></p>
            <p style="padding-top:5px; font-size: 220px"><b><?php echo $jml_detect_all; ?></b></p>
            <!-- <p style="padding-top:5px; font-size: 45px">10000</p> -->
      ...
      <div class="col-xs-4 col-lg-4">
         <div class="error-o pull-left text-center"><br>
			<p style="padding-top: 50px;font-size: 120px"><b>ERROR</b></p>
            <p style="padding-top:5px; font-size: 220px"><b><?php echo $jml_error_all; ?></b></p>
...
<section class="contentss">
   <div class="row">
      ...
      <div class="col-md-4">
         <div class="box box-solid" style="background-color: #e9e9e9;">
            <div class="box-header with-border">
               <h3 class="text-center" STYLE="font-size: 65px"><b>FACTORY A</b></h3>
            </div>
            <div class="box-body">
               <table class="table text-center">
                  <tr>
                     <td bgcolor="#438bc6" class="head" style="min-width:200px;font-size: 70px"><b>PASS</b> <p class="numb text-center"><b style="font-size: 70px"><?php echo $jml_array['jml_pass']; ?></b></p></td>
                     <td></td>
                     <td bgcolor="#da5550" class="head" style="min-width:200px;font-size: 70px"><b>DETECT</b> <p class="numb text-center"><b style="font-size: 70px"><?php echo $jml_array['jml_detect']; ?></b></p></td>
                     <td></td>
                     <td bgcolor="#f2aa56" class="head" style="min-width:200px;font-size: 70px"><b>ERROR</b> <p class="numb text-center" ><b style="font-size: 70px"><?php echo $erro_a['jml_error_a']; ?></b></p></td>
                  </tr>
               </table>
            </div>
         </div>
    ...
    <?php }?>
	 <?php }else{?>
	  <div class="col-md-4">
         <div class="box box-solid" style="background-color: #e9e9e9;">
            ...
            <div class="box-body">
               <table class="table text-center">
                  <tr>
                     <td bgcolor="#438bc6" class="head" style="min-width:200px;font-size: 70px"><b>PASS</b> <p class="numb text-center"><b style="font-size: 70px"><?php echo 0; ?></b></p></td>
                     <td></td>
                     <td bgcolor="#da5550" class="head" style="min-width:200px;font-size: 70px"><b>DETECT</b> <p class="numb text-center"><b style="font-size: 70px"><?php echo 0; ?></b></p></td>
                     <td></td>
                     <td bgcolor="#f2aa56" class="head" style="min-width:200px;font-size: 70px"><b>ERROR</b> <p class="numb text-center"><b style="font-size: 70px"><?php echo 0; ?></b></p></td>
                  </tr>
               </table>
            </div>
         </div>
      ...
      <?php
      // FACTORY B (PER GEDUNG)
        $sql_cek1 = "SELECT no_cell FROM dbo.[gedung_b]";
        $q_cek1 = sqlsrv_query($con, $sql_cek1);
		if (sqlsrv_has_rows($q_cek1) === true){
			 $sql_jumlah_pass = "SELECT SUM(pass) AS jml_pass, SUM(detect) AS jml_detect, SUM(error) AS jml_error FROM dbo.[gedung_b]";
        $q_jml_pass = sqlsrv_query($con, $sql_jumlah_pass);
        while ($jml_array = sqlsrv_fetch_array($q_jml_pass, SQLSRV_FETCH_BOTH)){
	  $sql_erra_b = "SELECT count(error) AS jml_error_b FROM dbo.[gedung_b] where error>=20 ";
	  $err_b = sqlsrv_query($con, $sql_erra_b);
	  $erro_b = sqlsrv_fetch_array($err_b, SQLSRV_FETCH_BOTH);
	  ?>
      <div class="col-md-4">
         <div class="box box-solid" style="background-color: #e9e9e9">
            <div class="box-header with-border">
               <h3 class="text-center" STYLE="font-size: 65px"><b>FACTORY B</b></h3>
            </div>
            <div class="box-body">
               <table class="table text-center">
                  <tr>
                     ...
                     <td bgcolor="#da5550" class="head" style="min-width:200px;font-size: 70px"><b>DETECT</b><p class="numb text-center"><b style="font-size: 70px"><?php echo $jml_array['jml_detect']; ?></b></p></td>
                     <td></td>
                     <td bgcolor="#f2aa56" class="head" style="min-width:200px;font-size: 70px"><b>ERROR</b><p class="numb text-center"><b style="font-size: 70px"><?php echo $erro_b['jml_error_b']; ?></b></p></td>
                  </tr>
               </table>
            </div>
         </div>
      ...
      <div class="col-md-4">
         <div class="box box-solid" style="background-color: #e9e9e9">
            <div class="box-header with-border">
               <h3 class="text-center" STYLE="font-size: 65px"><b>FACTORY C</b></h3>
            </div>
            <div class="box-body">
               <table class="table text-center">
                  <tr>
                     ...
                     <td bgcolor="#da5550" class="head" style="min-width:200px;font-size: 70px"><b>DETECT</b><p class="numb text-center"><b style="font-size: 70px"><?php echo $jml_array['jml_detect']; ?></b></p></td>
                     <td></td>
                     <td bgcolor="#f2aa56" class="head" style="min-width:200px;font-size: 70px"><b>ERROR</b><p class="numb text-center"><b style="font-size: 70px"><?php echo $erro_c['jml_error_c']; ?></b></p></td>
                  </tr>
               </table>
            </div>
         </div>
     ...
     <div class="row">
      <div class="col-md-4">
         <div class="box box-solid" style="background-color: #e9e9e9">
            <div class="box-header with-border">
               <h3 class="text-center" STYLE="font-size: 65px"><b>FACTORY D</b></h3>
            </div>
            <div class="box-body">
               <table class="table text-center">
                  <tr>
                     ...
                     <td bgcolor="#da5550" class="head" style="min-width:200px;font-size: 70px"><b>DETECT</b><p class="numb text-center"><b style="font-size: 70px"><?php echo $jml_array['jml_detect']; ?></b></p></td>
                     <td></td>
                     <td bgcolor="#f2aa56" class="head" style="min-width:200px;font-size: 70px"><b>ERROR</b><p class="numb text-center"><b style="font-size: 70px"><?php echo $erro_d['jml_error_d']; ?></b></p></td>
                  </tr>
               </table>
            </div>
         </div>
     ...
     <?php
      //FACTORY E (PER GEDUNG)
  
        $sql_cek2 = "SELECT no_cell FROM dbo.[gedung_e]";
        $q_cek2 = sqlsrv_query($con, $sql_cek2);
		if (sqlsrv_has_rows($q_cek2) === true){
		$sql_jumlah_pass = "SELECT SUM(pass) AS jml_pass, SUM(detect) AS jml_detect, SUM(error) AS jml_error FROM dbo.[gedung_e]";
        $q_jml_pass = sqlsrv_query($con, $sql_jumlah_pass);
        while ($jml_array = sqlsrv_fetch_array($q_jml_pass, SQLSRV_FETCH_BOTH)){
	  $sql_erra_e = "SELECT count(error) AS jml_error_e FROM dbo.[gedung_e] where error>=20 ";
	  $err_e = sqlsrv_query($con, $sql_erra_e);
	  $erro_e = sqlsrv_fetch_array($err_e, SQLSRV_FETCH_BOTH);
	  ?>
      
      <div class="col-md-4">
         <div class="box box-solid" style="background-color: #e9e9e9">
            <div class="box-header with-border">
               <h3 class="text-center" STYLE="font-size: 65px"><b>FACTORY E</b></h3>
            </div>
            <div class="box-body">
               <table class="table text-center">
                  <tr>
                     ...
                     <td bgcolor="#da5550" class="head" style="min-width:200px;font-size: 70px"><b>DETECT</b><p class="numb text-center"><b style="font-size: 70px"><?php echo $jml_array['jml_detect']; ?></b></p></td>
                     <td></td>
                     <td bgcolor="#f2aa56" class="head" style="min-width:200px;font-size: 70px"><b>ERROR</b><p class="numb text-center"><b style="font-size: 70px"><?php echo $erro_e['jml_error_e']; ?></b></p></td>
                  </tr>
               </table>
            </div>
         </div>
   ...
   <div class="text-center">
      ...
      //kondisi untuk memasukkan data ke tabel data_daily
      if ($pecah_jam==17 && $pecah_menit==00) {
